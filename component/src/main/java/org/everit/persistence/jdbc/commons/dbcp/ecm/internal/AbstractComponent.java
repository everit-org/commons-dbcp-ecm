...
@StringAttributes({
    @StringAttribute(attributeId = DSFConstants.ATTR_DEFAULT_AUTO_COMMIT,
        priority = AttributePriority.P02_DEFAULT_AUTO_COMMIT, label = "Default auto commit mode",
    ...
    @StringAttribute(attributeId = DSFConstants.ATTR_DEFAULT_READ_ONLY,
        priority = AttributePriority.P05_DEFAULT_READ_ONLY, label = "Default read-only state",
    ...
    @StringAttribute(attributeId = DSFConstants.ATTR_DEFAULT_TRANSACTION_ISOLATION,
        priority = AttributePriority.P06_DEFAULT_TRANSACTION_ISOLATION,
    ...
    @StringAttribute(attributeId = DSFConstants.ATTR_DEFAULT_CATALOG,
        priority = AttributePriority.P07_DEFAULT_CATALOG, defaultValue = "",
    ...
    @StringAttribute(attributeId = DSFConstants.ATTR_VALIDATION_QUERY,
        priority = AttributePriority.P27_VALIDATION_QUERY, defaultValue = "",
    ...
    @StringAttribute(attributeId = DSFConstants.ATTR_JMX_NAME,
        priority = AttributePriority.P36_JMX_NAME, defaultValue = "", label = "JMX name",
...
@BooleanAttributes({
    @BooleanAttribute(attributeId = DSFConstants.ATTR_ENABLE_AUTO_COMMIT_ON_RETURN,
        defaultValue = true, priority = AttributePriority.P03_ENABLE_AUTO_COMMIT_ON_RETURN,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_ROLLBACK_ON_RETURN,
        defaultValue = true, priority = AttributePriority.P04_ROLLBACK_ON_RETURN,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_CACHE_STATE,
        defaultValue = true, priority = AttributePriority.P13_CACHE_STATE, label = "Cache state",
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_LIFO,
        defaultValue = BaseObjectPoolConfig.DEFAULT_LIFO, priority = AttributePriority.P14_LIFO,
        label = "LIFO",
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_POOL_PREPARED_STATEMENTS,
        defaultValue = false, priority = AttributePriority.P17_POOL_PREPARED_STATEMENTS,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_TEST_ON_CREATE,
        defaultValue = false, priority = AttributePriority.P19_TEST_ON_CREATE,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_TEST_ON_BORROW,
        defaultValue = true, priority = AttributePriority.P20_TEST_ON_BORROW,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_TEST_ON_RETURN,
        defaultValue = false, priority = AttributePriority.P21_TEST_ON_RETURN,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_TEST_WHILE_IDLE,
        defaultValue = false, priority = AttributePriority.P26_TEST_WHILE_IDLE,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_ACCESS_TO_UNDERLYING_CONNECTION_ALLOWED,
        defaultValue = false,
        priority = AttributePriority.P30_ACCESS_TO_UNDERLYING_CONNECTION_ALLOWED,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_REMOVE_ABANDONED_ON_MAINTENANCE,
        defaultValue = false, priority = AttributePriority.P31_REMOVE_ABANDONED_ON_MAINTENANCE,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_REMOVE_ABANDONED_ON_BORROW,
        defaultValue = false, priority = AttributePriority.P32_REMOVE_ABANDONED_ON_BORROW,
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_LOG_ABANDONED,
        defaultValue = false, priority = AttributePriority.P34_LOG_ABANDONED,
        label = "Log abandoned",
    ...
    @BooleanAttribute(attributeId = DSFConstants.ATTR_ABANDONED_USAGE_TRACKING,
        defaultValue = false, priority = AttributePriority.P35_ABANDONED_USAGE_TRACKING,
...
@IntegerAttributes({
    @IntegerAttribute(attributeId = DSFConstants.ATTR_MAX_TOTAL,
        ...
        priority = AttributePriority.P09_MAX_TOTAL, label = "Max. total",
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_MAX_IDLE,
        ...
        priority = AttributePriority.P10_MAX_IDLE, label = "Max. idle",
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_MIN_IDLE,
        ...
        priority = AttributePriority.P11_MIN_IDLE, label = "Min. idle connections",
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_INITIAL_SIZE,
        defaultValue = 0,
        priority = AttributePriority.P12_INITIAL_SIZE, label = "Initial size",
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_MAX_OPEN_PREPARED_STATEMENTS,
        defaultValue = GenericObjectPoolConfig.DEFAULT_MAX_TOTAL,
        priority = AttributePriority.P18_MAX_OPEN_PREPARED_STATEMENTS,
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_NUM_TESTS_PER_EVICTION_RUN,
        ...
        priority = AttributePriority.P24_NUM_TESTS_PER_EVICTION_RUN,
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_VALIDATION_QUERY_TIMEOUT,
        defaultValue = -1,
        priority = AttributePriority.P28_VALIDATION_QUERY_TIMEOUT,
    ...
    @IntegerAttribute(attributeId = DSFConstants.ATTR_REMOVE_ABANDONED_TIMEOUT,
        ...
        priority = AttributePriority.P33_REMOVE_ABANDONED_TIMEOUT,
...
@LongAttributes({
    @LongAttribute(attributeId = DSFConstants.ATTR_MAX_CONN_LIFETIME_MILLIS,
        defaultValue = -1,
        priority = AttributePriority.P15_MAX_CONN_LIFETIME_MILLIS,
    ...
    @LongAttribute(attributeId = DSFConstants.ATTR_MAX_WAIT_MILLIS,
        ...
        priority = AttributePriority.P16_MAX_WAIT_MILLIS, label = "Max. wait",
    ...
    @LongAttribute(attributeId = DSFConstants.ATTR_TIME_BETWEEN_EVICTION_RUNS_MILLIS,
        ...
        priority = AttributePriority.P22_TIME_BETWEEN_EVICTION_RUNS_MILLIS,
    ...
    @LongAttribute(attributeId = DSFConstants.ATTR_MIN_EVICTABLE_IDLE_TIME_MILLIS,
        ...
        priority = AttributePriority.P25_MIN_EVICTABLE_IDLE_TIME_MILLIS,
    ...
    @LongAttribute(attributeId = DSFConstants.ATTR_SOFT_MIN_EVICTABLE_IDLE_TIME_MILLIS,
        ...
        priority = AttributePriority.P23_SOFT_MIN_EVICTABLE_IDLE_TIME_MILLIS,
...
public abstract class AbstractComponent {
  ...
  @StringAttribute(attributeId = DSFConstants.ATTR_CONNECTION_INIT_SQLS, defaultValue = "",
      priority = AttributePriority.P29_CONNECTION_INIT_SQLS, label = "Connection init SQLs",
